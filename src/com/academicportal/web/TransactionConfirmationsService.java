...
public class TransactionConfirmationsService {
	...
	public Page<TransactionConfirmations> searchConfirmations(String category, String product, String status,
		...
		if(LOGGER.isInfoEnabled()){
			repo.findAll(PageRequest.of(0,5)).forEach(t->LOGGER.info("SIMPLE ROW ->id={} , category=[{}], entitySet = [{}] , docTypes=[{}],statusSet[{}]",t.getId(),t.getCategory(),t.getEntity(),t.getDocumentType(),t.getStatus()));
		}
